...
<html>
	...
	<body>
		...
		<?php 
			for ($i=0; $i < 5; $i++) {
				$jsonkey = file_get_contents("http://alunos.estg.ipvc.pt/~pmoreira/EURO1300/EuroKeyWS.php");
				$phpkey = json_decode($jsonkey);
				echo keyAsXML($phpkey->data->numbers,$phpkey->data->stars);
			}
		?>
	</body>
</html>